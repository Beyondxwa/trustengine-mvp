  ...
  try {
    ...
    const sessionRes = await fetch("https://api.stripe.com/v1/checkout/sessions", {
      ...
      body: new URLSearchParams({
        ...
        success_url: success_url || "https://TRUSTENGINE_PROD_URL/billing/success?session_id={CHECKOUT_SESSION_ID}",
        cancel_url: cancel_url || "https://TRUSTENGINE_PROD_URL/billing/cancel",
